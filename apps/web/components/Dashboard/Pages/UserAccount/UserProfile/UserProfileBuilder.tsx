        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <div className="col-span-1 border-r pr-4">
            ...
            <div className="pt-4">
              ...
              >
                <SelectTrigger className="w-full p-0 border-0 bg-black overflow-hidden rounded-md">
                  <div className="w-full">
                    <div className="flex h-9 w-full items-center justify-center rounded-md bg-black px-4 py-2 text-sm font-medium text-white hover:bg-black/90 shadow-sm transition-colors">
