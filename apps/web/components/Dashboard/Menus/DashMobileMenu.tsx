    ...
    <>
      ...
      >
        ...
        >
          ...
          <PillLink href="/dash/sniper" icon={<Target size={18} weight="fill" />} active={isActive('/dash/sniper')} className="hidden min-[340px]:flex" />
          <PillLink href="/dash/campaign" icon={<FlagBanner size={18} weight="fill" />} active={isActive('/dash/campaign')} className="hidden min-[390px]:flex" />
          <PillLink href="/dash/courses" icon={<BookOpen size={18} weight="fill" />} active={isActive('/dash/courses')} className="hidden min-[430px]:flex" />
          <PillLink href="/dash/assignments" icon={<Files size={18} weight="fill" />} active={isActive('/dash/assignments')} className="hidden min-[470px]:flex" />
          <PillLink href="/dash/analytics" icon={<ChartBar size={18} weight="fill" />} active={isActive('/dash/analytics')} className="hidden min-[510px]:flex" />
          {isAdmin && (
            <>
              <PillLink href="/dash/users/settings/users" icon={<Users size={18} weight="fill" />} active={isActive('/dash/users')} className="hidden min-[550px]:flex" />
              {isEnabled('communities') && (
                <PillLink href="/dash/communities" icon={<ChatsCircle size={18} weight="fill" />} active={isActive('/dash/communities')} className="hidden min-[590px]:flex" />
              )}
              {isEnabled('podcasts') && (
                <PillLink href="/dash/podcasts" icon={<Headphones size={18} weight="fill" />} active={isActive('/dash/podcasts')} className="hidden min-[630px]:flex" />
              )}
              {isEnabled('boards') && (
                <PillLink href="/dash/boards" icon={<ChalkboardSimple size={18} weight="fill" />} active={isActive('/dash/boards')} className="hidden min-[670px]:flex" />
              )}
              {isEnabled('playgrounds') && (
                <PillLink href="/dash/playgrounds" icon={<Cube size={18} weight="fill" />} active={isActive('/dash/playgrounds')} className="hidden min-[710px]:flex" />
              )}
              <PillLink href="/dash/org/settings/general" icon={<Buildings size={18} weight="fill" />} active={isActive('/dash/org')} className="hidden min-[750px]:flex" />
              {isEnabled('payments') && (
                <PillLink href="/dash/payments/overview" icon={<CurrencyCircleDollar size={18} weight="fill" />} active={isActive('/dash/payments')} className="hidden min-[790px]:flex" />
              )}
            </>
          )}
          ...
          <>
            ...
            >
              ...
              <div className="py-2 px-2 max-h-[52vh] overflow-y-auto overscroll-contain space-y-px">
                ...
                <PanelItem href="/dash/sniper" icon={<Target size={15} weight="fill" />} label="Sniper Mode" active={isActive('/dash/sniper')} onClick={close} />
                <PanelItem href="/dash/campaign" icon={<FlagBanner size={15} weight="fill" />} label="Campaign Mode" active={isActive('/dash/campaign')} onClick={close} />
