...
def _ilike_any(columns: Sequence[ColumnElement[Any]], pattern: str) -> ColumnElement[bool]:
    ...
    responsible for escaping â€” no string interpolation on user input.
    """
...
async def search_across_org(
    ...
    - Pattern matching goes through SQLAlchemy `ilike` â€” fully parameterized.
    ...
    # â”€â”€ Users (org members only; anonymous and non-member traffic is denied) â”€
    if only_public:
        users: list = []
        total_users = 0
    else:
    ...
    # â”€â”€ Communities â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    communities_q = (
        select(Community)
    ...
    # â”€â”€ Discussions (inherit access from their community) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    discussions_q = (
        select(Discussion, Community.community_uuid)
    ...
    # â”€â”€ Playgrounds (published only; restricted are usergroup-gated elsewhere) â”€
    playgrounds_q = (
        select(Playground)
    ...
    # â”€â”€ Podcasts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    podcasts_q = (
        select(Podcast)
...
async def _build_collection_reads(
    ...
    """Hydrate each collection with its course list (now empty)."""
