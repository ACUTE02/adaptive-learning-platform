...
class ResourceAccessChecker:
    ...
    def __init__(
        ...
        # page can trigger check_resource_access 2â€“3 times; without these caches
    ...
    async def check_access(
        ...
        # Superadmin bypass â€” platform admins act on any tenant without an org
    ...
    async def _check_dashboard_read_access(
        ...
        # resources still get denied here â€” which is the intended behavior.
        return await self._check_public_view_read_access(resource_uuid, config)
    ...
    async def _get_parent_uuid_by_id(
        ...
        if parent_config.resource_type == "podcasts":
...
def _get_request_checker(
    ...
    that request. This collapses what was previously 2â€“3Ã— redundant author /
