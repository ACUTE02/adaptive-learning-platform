...
@pytest.fixture
async def role(db):
    # Prerequisite row for UserOrganization.role_id FK. Kept minimal â€” tests
...
# â”€â”€ _require_api_token â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ /me â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Dynamic dropdowns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Subscriptions CRUD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestZapierSubscriptions:
    ...
    async def test_list_subscriptions_only_own_org_and_zapier_source(
        ...
        # A manual (non-Zapier) webhook in the same org â€” should NOT appear
        db.add(
            WebhookEndpoint(
        ...
        # A Zapier webhook in another org â€” should NOT appear
        db.add(
            WebhookEndpoint(
    ...
    async def test_delete_refuses_cross_org(
        ...
        # Our token tries to delete â€” should 404 (not leak existence)
        with _patch_plan_pro():
            with pytest.raises(HTTPException) as exc:
                await zapier_delete_subscription(
                    subscription_id=created.id,
