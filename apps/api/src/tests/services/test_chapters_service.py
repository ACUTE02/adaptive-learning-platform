...
class TestApplyLocksToChapters:
    ...
    async def test_anonymous_user_locked_out_of_restricted_chapters(
        ...
        """Lines 394-398, 420-422, 440-442: restricted lock_type â†’ uuid collected;
        anonymous user â†’ chapter+activity locked and content stripped."""
    ...
    async def test_course_grants_access_unlocks_activities(
        ...
        course_grants_access=True â†’ activity_locked=False even if activity is restricted."""
        ...
        # Grant access to the course_uuid itself â†’ course_grants_access=True
        ...
        # course_grants_access=True â†’ activity must NOT be locked (line 427-428)
