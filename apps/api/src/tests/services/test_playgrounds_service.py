...
class TestPlaygroundsService:
    ...
    async def test_list_org_playgrounds_empty_returns_empty(
        ...
        """Line 211: no playgrounds for the org â†’ returns [] immediately."""
    ...
    async def test_list_org_playgrounds_no_allowed_returns_empty(
        ...
        """Line 272: playgrounds exist but none pass the filter for the user â†’ returns []."""
        await _make_playground(
            db,
            org,
            admin_user,
    ...
    async def test_list_org_playgrounds_restricted_skips_anonymous_and_no_access(
        ...
        # Line 255: anonymous user â†’ skip restricted playground
        ...
        # Line 261: non-admin, not owner, no group access â†’ skip
