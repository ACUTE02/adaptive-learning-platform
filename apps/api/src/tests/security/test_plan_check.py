...
class TestPlanCheck:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # can't be resolved â€” their routers mount handlers whose
    ...
    async def test_require_plan_for_usergroups_success_and_no_org(self, db, org):
        ...
        with patch(
            ...
            # No discriminator â†’ fall through (handler RBAC still runs).
            # Resolvable discriminator â†’ plan gate evaluates and returns True.
            assert await dependency(_request(), db) is True
