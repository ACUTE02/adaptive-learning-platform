...
- A member of org A reading a block from a private course in org B â†’ 403.
- A member of org A reading a block from their own course â†’ 200.
- An anonymous reader accessing a block from a public + published course â†’ 200.
- An anonymous reader accessing a block from a non-public or unpublished course â†’ 403.
"""
