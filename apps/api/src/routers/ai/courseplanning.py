...
async def start_course_planning_session(
    ...
    # Get AI model â€” pro models cost more credits
...
async def finalize_course_plan(
    ...
    try:
        ...
        logger.error(f"Failed to finalize course plan: {e}")
        raise HTTPException(status_code=500, detail="An internal error occurred while finalizing the course plan.")
